...
def evaluate_model(model,tokenizer,sources,raw_dataset):
	...
	print("individual 1-gram %f" % corpus_bleu(actual,predicted,weights=(0,1,0,0)))
	print("individual 1-gram %f" % corpus_bleu(actual,predicted,weights=(0,0,1,0)))
	print("individual 1-gram %f" % corpus_bleu(actual,predicted,weights=(0,0,0,1)))
